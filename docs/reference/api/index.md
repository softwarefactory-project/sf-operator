...
| `podAnnotations` _object (keys:string, values:string)_ | Optional annotations to add to the logserver pod template (e.g. io.kubernetes.cri-o.TrySkipVolumeSELinuxLabel for CRI-O) | -|
